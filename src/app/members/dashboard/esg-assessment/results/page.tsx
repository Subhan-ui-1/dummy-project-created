...
export default function ESGResultsPage() {
  ...
  const tierColor =
    tier === "Gold" ? "#F2C94C" : tier === "Silver" ? "#BFC7D5" : "#D6A27D";
  ...
  return (
    <section className="space-y-8">
      ...
      {/* Header */}
      <div
        className="rounded-xl border bg-white shadow-sm p-6 flex items-center justify-between"
      ...
      >
        <div>
          ...
          >
            ESG Assessment Results Dashboard
          </div>
          <div className="text-xs" style={{ color: "var(--fourth)" }}>
            Comprehensive scoring, clear tiering, and next steps
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div
            className="px-3 py-1 rounded text-xs font-medium"
            style={{ backgroundColor: tierColor, color: "#161326" }}
          >
            {tier} Tier
          </div>
          <a
            href="/members/dashboard/esg-assessment"
            className="h-9 px-3 rounded-lg text-xs shadow-sm hover:opacity-90 flex items-center justify-center"
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span
              ...
              style={{
                backgroundColor: "rgba(147,147,158,0.2)",
                color: "var(--secondary)",
              }}
            >
              0–100
          ...
          <div className="mt-2 text-xs" style={{ color: "var(--fourth)" }}>
            You are tracking well. Aim for 75+ to reach Gold.
          </div>
        </div>
        {[
          {
          ...
          >
            ...
            <div className="mt-1 text-xs" style={{ color: "var(--fourth)" }}>
              {item.help}
            </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        >
          ...
          <div className="mt-2 grid grid-cols-3 gap-2 text-xs">
            <div
              ...
              style={{ borderColor: "var(--fifth)", color: "#D6A27D" }}
            >
              Bronze 0–49
            </div>
            <div
        ...
        <div
          className="rounded-lg border bg-white shadow-sm p-4 text-sm lg:col-span-2"
          style={{ borderColor: "var(--fifth)" }}
        >
          <div className="font-medium" style={{ color: "var(--secondary)" }}>
            How to read scores
          ...
          <ul
            className="mt-2 grid sm:grid-cols-3 gap-2 text-xs"
            style={{ color: "var(--fourth)" }}
          >
            <li
              className="rounded border p-2"
              style={{ borderColor: "var(--fifth)" }}
            >
              60–69: Solid foundation, formalize policies
            </li>
            <li
              className="rounded border p-2"
              style={{ borderColor: "var(--fifth)" }}
            >
              70–79: Mature practices, expand coverage
            </li>
            <li
              className="rounded border p-2"
              style={{ borderColor: "var(--fifth)" }}
            >
              80+: Leading practice, external assurance
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <a
          href="/members/dashboard/esg-assessment"
          className="h-10 px-4 rounded-lg text-sm shadow-sm hover:opacity-90 flex items-center justify-center"
          style={{ backgroundColor: "var(--primary)", color: "#161326" }}
        >
          Retake assessment
        </a>
