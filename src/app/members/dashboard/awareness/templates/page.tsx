...
export default function MemberAwarenessTemplatesPage() {
  return (
    <section className="space-y-6">
      <AwarenessTabs />
      <h2 className="text-xl font-semibold" style={{ color: 'var(--fourth)' }}>Awareness: Templates</h2>
      <p className="text-sm" style={{ color: 'var(--secondary)' }}>Download templates to accelerate your ESG program.</p>
