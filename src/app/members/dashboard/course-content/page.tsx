  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        >
          Course Content — Carbon Accounting Fundamentals
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[280px_1fr_280px]">
            ...
            >
              ...
              {activeIdx === i && (
                <div
                  ...
                  style={{ color: "var(--fourth)" }}
                >
                  Duration: 12:45 • Language: {language}
                </div>
              )}
            </button>
          ))}
        ...
        <main className="space-y-4">
          <div className="aspect-video w-full rounded-lg relative overflow-hidden flex items-center justify-center">
            <Image
              src="/Tunley-Carbon-Accounting-FAQs_Thumbnail_play.jpg"
              alt="Course thumbnail"
              fill
              style={{ objectFit: "cover" }}
            />
            <div
              className="h-20 w-20 rounded-full bg-white/90 flex items-center justify-center text-2xl"
              style={{ color: "var(--secondary)" }}
            >
              ▶
            </div>
          ...
          >
            ...
            <p>
              Scope 3 emissions are indirect emissions occurring across your
              value chain and are often the largest share of a company&apos;s
              carbon footprint.
            </p>
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              ...
              >
                Scope 3 Calculation Template (Excel)
              </span>
              <span
                className="rounded border px-2 py-1"
                style={{ borderColor: "var(--fifth)" }}
        ...
        {/* Right - course image */}
        <aside
          className="rounded-lg border bg-white p-4 h-fit"
          style={{ borderColor: "var(--fifth)" }}
        >
          <div
          ...
          <Image
            ...
            style={{ borderColor: "var(--fifth)" }}
          />
          <div className="mt-2 text-[11px]" style={{ color: "var(--fourth)" }}>
            Illustrative image for learning content (replace with brand asset
            anytime).
          </div>
        </aside>
      </div>
